class CryptoCurrency {
 // final String id;
  bool isFavorite;
  final String symbol;
  final String fullName; // Assuming fullname corresponds to the name_full from the list API
  final String icon; // Assuming icon corresponds to the icon_url from the list API
